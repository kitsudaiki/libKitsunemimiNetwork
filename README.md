...
![Github workfloat status](https://img.shields.io/github/workflow/status/kitsudaiki/libKitsunemimiNetwork/build-and-test/master?label=build%20and%20test&style=flat-square)
